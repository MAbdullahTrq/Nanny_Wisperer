...
export default async function HostProfilePage() {
  ...
  if (!session?.user) redirect('/login?callbackUrl=/host/profile');
  ...
  const onboardingComplete = Boolean(user.airtableHostId);
          ...
          {onboardingComplete ? (
            <>
              <p className="text-dark-green/80 text-sm mb-4">
                Your family profile is complete. You can update your details anytime.
              </p>
              <Link
            ...
            <>
              <p className="text-dark-green/90 text-sm mb-4">
                Complete your family profile to receive shortlists and matches.
              </p>
              <Link
                href="/host/onboarding"
